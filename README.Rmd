...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/sokbae/ciccr.svg?branch=master)](https://travis-ci.com/github/sokbae/ciccr)
...
Sung Jae Jun and Sokbae Lee. Causal Inference under Outcome-Based Sampling with Monotonicity Assumptions. 
