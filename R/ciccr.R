#' @docType package
#' @name ciccr
#' @title ciccr: a package for causal inference in case-control studies
#'
#' @description The ciccr package provides methods for causal infernce in case-control studies.
#'
#' @section Functions:
